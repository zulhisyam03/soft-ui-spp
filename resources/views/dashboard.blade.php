                ...
                <div class="card-body p-3">
                    <div class="row">
                        ...
                        <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                            <div class="border-radius-lg h-100 p-3" style="box-shadow: 0px 0px 20px rgba(0, 0, 0, 0.1);">
                                <img src="../assets/img/shapes/waves-white.svg"
                                    class="position-absolute h-100 w-50 top-0 d-lg-block d-none" alt="waves">
                                <div class="position-relative d-flex align-items-center justify-content-center h-100">
                                    <img class="w-100 position-relative z-index-2 pt-4" src="../assets/img/no-images.png"
                                        alt="no-images" height="200px">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card h-100 p-3">
                <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100"
                    ...
                    <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                        <h5 class="text-white font-weight-bolder mb-4 pt-2">Cara Melakukan Pembayaran SPP</h5>
                        <ol class="text-white">
                            <li>Lakukan Transfer Ke No.Rekening xxxxxxxx an/ zzzzzzz</li>
                            <li>Masuk Ke Dashboard Mahasiswa</li>
                            <li>Input Form Pembayaran SPP</li>
                            <li>Upload Bukti Pembayaran</li>
                            <li>Submit Form Pembayaran SPP</li>
                        </ol>
