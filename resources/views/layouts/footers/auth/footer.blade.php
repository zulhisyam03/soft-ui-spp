        ...
        <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-12 mb-lg-0 mb-4">
                <div class="copyright text-center text-sm text-muted text-lg-start">
                    ...
                    <a style="color: #252f40;" href="https://www.linkedin.com/in/zul-hisyam-2783b4222/" class="font-weight-bold ml-1" target="_blank">JULLE</a>.
                    for a better web.
                </div>
            </div>
            {{-- <div class="col-lg-6">
                <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                    ...
                    <li class="nav-item">
                        <a href="https://www.linkedin.com/in/zul-hisyam-2783b4222/" class="nav-link text-muted" target="_blank">About Us</a>
                    </li>
                    <li class="nav-item">
